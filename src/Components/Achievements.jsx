        ...
        <div className="space-y-6">
          {achievements.map((item, index) => (
            <div
              ...
              className="bg-gray-800/40 backdrop-blur-md rounded-xl p-6 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300 hover:bg-gray-800/60 group focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
            >
